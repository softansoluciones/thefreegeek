...
//document.write('<script async src="https://www.googletagmanager.com/gtag/js?id=UA-146300590-1"></script>');
//document.write('<script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag("js", new Date()); gtag("config", "UA-146300590-1");</script>');
//document.write('<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>');
//document.write('<script>(adsbygoogle = window.adsbygoogle || []).push({google_ad_client: "ca-pub-8052078318326884", enable_page_level_ads: true});</script>');
//document.write('');